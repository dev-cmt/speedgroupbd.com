        ...
        <div class="nav-header">
			...
			<a href="{{url('/')}}" class="brand-logo">
                <span class="logo-abbr" width="50" height="50">
					<h2 style="font-size: 32px">S</h2>
				</span>
                <span class="brand-title" width="74" height="22">
					<h2 style="font-size: 32px">GBD</h2>
				</span>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right main-notification">
											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h6 class="mb-1">{{$row->name}}<small class="d-block">{{date("j F Y", strtotime($row->created_at))}}</small></h6>
														<p class="mb-1 description_1">{{$row->description}}</p>
													</div>
												</div>
											</li>
											@endforeach
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ Route('profile_show', auth()->user()->id )}}" class="dropdown-item ai-icon">
