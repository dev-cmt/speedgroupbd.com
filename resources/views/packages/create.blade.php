...
<x-app-layout>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" step="0.01" id="val-sale-price" name="sale_price" class="form-control @error('sale_price') is-invalid @enderror"
                                                placeholder="Enter sale price (optional)" value="{{ old('sale_price') }}">
                                            @error('sale_price')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" id="val-max-persons" name="max_persons" class="form-control @error('max_persons') is-invalid @enderror"
                                                placeholder="e.g., 12" value="{{ old('max_persons', 12) }}">
                                            @error('max_persons')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" id="val-review-count" name="review_count" class="form-control @error('review_count') is-invalid @enderror"
                                                placeholder="e.g., 1" value="{{ old('review_count', 1) }}">
                                            @error('review_count')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" step="0.1" min="0" max="5" id="val-rating" name="rating" class="form-control @error('rating') is-invalid @enderror"
                                                placeholder="e.g., 5.0" value="{{ old('rating', 5.0) }}">
                                            @error('rating')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="is-featured" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is-featured">
                                                    Featured
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="is-bestseller" name="is_bestseller" value="1" {{ old('is_bestseller') ? 'checked' : '' }}>
                                ...
                                <div class="col-xl-12">
                                    <div class="row mt-2" id="images-container">
                                        ...
                                        <div class="col-md-1 col-sm-1 col-2 mb-3">
                                            <label for="images" class="image-container d-flex flex-column align-items-center justify-content-center position-relative" style="cursor:pointer; min-height:100%; border:2px dashed #ced4da; box-shadow:0 0 15px #845adf8c;">
                                                <i class="flaticon-381-add-1 pt-2 text-secondary fs-3"></i>
                                                <span class="text-secondary fs-6 p-2">Add Image</span>
                                                <span class="selected-count position-absolute p-1 text-primary fs-7" style="top:0; right:0"></span>
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div id="itinerary-wrapper">
                                        <div class="border p-3 mb-3 itinerary-item position-relative">
                                            ...
                                            <input type="number" name="itineraries[0][day_number]" class="form-control mb-2" value="1">
                                            
                                            <label>Title</label>
                                            <input type="text" name="itineraries[0][title]" class="form-control mb-2" placeholder="Arrive in Zürich">

                                            <label>Description</label>
                                            <textarea name="itineraries[0][description]" class="form-control mb-2" placeholder="Enter details"></textarea>
                                        </div>
                                    </div>
        ...
        $(function(){
            ...
            $('#images').on('change', function(){
                ...
                files.forEach(file => {
                    ...
                    reader.onload = e => {
                        const $div = $(`
                            <div class="col-md-1 col-sm-1 col-2 mb-3 text-center image-wrapper">
    ...
    <script>
        ...
        let i = 1; // Start from 1 since Day 1 already exists
