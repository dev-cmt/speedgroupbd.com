        ...
        <div class="tf-container">
            <div class="row">
                <div class="col-lg-12 center z-index1">
                    <h1 class="title"> Archieve Tour</h1>
...
@section('content')
    ...
    <section class="archieve-tour pt-5">
        <div class="tf-container">
            <div class="listing-list-car-wrap listing-list-car-wrap-grid3">
                ...
                <div class="listing-list-car-grid mb-60">
                    ...
                    <div class="tour-listing box-sd">
                        ...
                        <div class="tour-listing-content">
                            <span class="map"><i class="icon-Vector4"></i>United States USA</span>
                            <h3 class="title-tour-list"><a href="{{route('page.package-details')}}">Days and 6 nights
                                    From Moscow</a>
                            </h3>
                            <div class="review">
                                <i class="icon-Star"></i>
                    ...
                    <div class="tour-listing box-sd">
                        ...
                        <div class="tour-listing-content">
                            <span class="map"><i class="icon-Vector4"></i>United States USA</span>
                            <h3 class="title-tour-list"><a href="{{route('page.package-details')}}">Days and 6 nights From Moscow</a>
                            </h3>
                            <div class="review">
                                <i class="icon-Star"></i>
                                <i class="icon-Star"></i>
                    ...
                    <div class="tour-listing box-sd">
                        <a href="{{route('page.package-details')}}" class="tour-listing-image">
                            ...
                            <img src="{{ asset('public') }}/images/travel-list/6.jpg" alt="Image Listing">
