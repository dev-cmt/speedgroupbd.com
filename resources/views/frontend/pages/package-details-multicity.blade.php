...
@section('breadcrumb')
    <section>
        <div class="tf-container full">
            <div class="row">
                <div class="col-md-12">
                    <img src="{{ asset('public') }}/images/pages/breakcrumb2.jpg" alt="image">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <ul class="nav justify-content-between tab-tour-single" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-tour-planing-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="pills-tour-planing" aria-selected="false"><i
                                    class="icon-destination-2-1"></i> Tour Planing</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-location-share-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="pills-location-share" aria-selected="false"><i
                                    class="icon-map-1"></i> Location share</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-reviews-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-reviews" type="button" role="tab"
                                aria-controls="pills-reviews" aria-selected="false"><i
                                    class="icon-favourite-1"></i> Reviews</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-pane fade show active" id="pills-information" role="tabpanel"
                                ...
                                <div class="col-lg-12">
                                    <div class="inner-heading-wrap flex-two">
                                        <div class="inner-heading">
                                            ...
                                            <h2 class="title">Thailand / Malaysia / Singapore tour package</h2>
                                            <ul class="flex-three list-wrap-heading">
                                                <li class="flex-three">
                                                    <i class="icon-time-left"></i>
                                                    <span>3 Night 4 Day</span>
                                                </li>
                                                <li class="flex-three">
                                                    <i class="icon-18"></i>
                                                    <span>Thailand / Malaysia / Singapore</span>
                                                </li>
                                        ...
                                        <div class="inner-price">
                                            <div class="flex-three">
                                                ...
                                                <span class="review">(8 Review)</span>
                                            </div>
                            ...
                            <div class="row mb-40 image-gallery-single">
                                <div class="col-12 col-sm-6">
                                    <img src="{{ asset('public') }}/images/travel-list/multicity/thailand-malaysia-singapore.jpg" alt="image">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="information-content-tour">
                                        <div class="description-wrap mb-2">
                                            <span class="description">প্যাকেজে থাকছে:</span>
                                            <p class="des">
                                                DAC - BKK - KUL - SIN<br>
                                                রিটার্ন এয়ারটিকেট<br>
                                                KUL - SIN - বাস টিকেট<br>
                                        ...
                                        <div class="description-wrap mb-2">
                                            ...
                                            <p class="des">
                                                Pattaya : ২ রাত <br>
                                                Bangkok : ১ রাত <br>
                                                Hotel : Welcome plaza - Pataya <br>
                                                Hotel : Anya Nana, Bangkok <br>
                                            </p>
                                            <h6>প্যাকেজে অন্তর্ভুক্ত:</h6>
                                            <p class="des">
                                                ► ৩*হোটেলে ৩ রাত ৪ দিন ব্যাংকক ও পাতায়া থাকার সুব্যবস্থা (টুইন শেয়ারিং)। <br>
                                                ► প্রতিদিন হোটেল এর রেস্টুরেন্ট এ সকালের বুফেট ব্রেকফাস্ট। <br>
                                                ► কোরাল আইল্যান্ড ট্যুর। <br>
                                                ► সকল ট্রান্সফার। <br>
                                                ► এয়ারপোর্ট পিক এন্ড ড্রপ। <br>
                                                ► বাংলাদেশি ট্রাভেল গাইড। <br>
                                            </p>
                                        </div>
                                        ...
                                        <hr>
                                        <div class="description-wrap mb-2">
                                            <span class="description">Malaysia:</span>
                                            <p class="des">
                                                কুয়ালালামপুর : ৩ রাত <br>
                                                ৩* হোটেল <br>
                                                Hotel : Hotel Metro KL center <br>
                                                প্রতিদিন সকালের নাস্তা <br>
                                                বিমানবন্দর টু হোটেল রিটার্ন ট্রান্সফার <br>
                                                কুয়ালালাম্পুর হাফ-ডে সিটি ট্যুর <br>
                                                সব ভ্রমণ এসআইসি ভিত্তিতে <br>
                                                সকল প্রকার ট্রাভেল ট্যাক্স ও ভ্যাট। <br>
                                            </p>
                                        </div>
                                        ...
                                        <hr>
                                        <div class="description-wrap mb-2">
                                            <span class="description">Singapore:</span>
                                            <p class="des">
                                                ৩ রাত <br>
                                                Hotel Arena or Tai Hoe Hotel <br>
                                                ৩* হোটেল <br>
                                                এয়ারপোর্টে পিক এন্ড ড্রপ <br>
                                            </p>
                                        </div>
                                        ...
                                        <div class="description-wrap mb-2">
                                            <p>
                                                <span style="font-weight: bolder">যোগাযোগ-</span> <br>
                                                01896 270 390 <br>
                                                01896 270 391 <br>
                                                01896 270 392 <br>
                                                01896 270 393 <br>
                                            ...
                                            <p class="py-4">
                                                <span style="font-weight: bolder;">Office Address:</span> Speed  Travels & Tours
                                            </p>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="side-bar-right">
                                        <div class="sidebar-widget">
                                            ...
                                            <form action="https://themesflat.co/" id="form-book-tour">
                                            ...
                                            <div class="recent-post-list">
                                                <div class="list-recent flex-three">
                                                    <a href="blog-details.html" class="recent-image">
                                                        <img src="{{ asset('public/frontend') }}/images/blog/re-blog1.jpg"
                                                            alt="Image">
                                                    </a>
                                                ...
                                                <div class="list-recent flex-three">
                                                    <a href="blog-details.html" class="recent-image">
                                                        <img src="{{ asset('public/frontend') }}/images/blog/re-blog2.jpg"
                                                            alt="Image">
                                                    </a>
                                                    <div class="recent-info">
                                                        <div class="start">
                                                ...
                                                <div class="list-recent flex-three">
                                                    <a href="blog-details.html" class="recent-image">
                                                        <img src="{{ asset('public/frontend') }}/images/blog/re-blog3.jpg"
                                                            alt="Image">
                                                    </a>
                                                    <div class="recent-info">
                                                        <div class="start">
                                ...
                                <div class="col-lg-8">
                                    <div class="localtion-content-tour">
                                        <div class="map2 relative mb-32">
                                            <iframe
                                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.902184964049!2d90.39156331543106!3d23.75087639459192!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b894b2e7b6e1%3A0x6c1f1e3e9e7e2e7e!2sDhaka%2C%20Bangladesh!5e0!3m2!1sen!2sbd!4v1620000000000!5m2!1sen!2sbd" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"
                                ...
                                <div class="col-lg-8">
                                    <div class="review-content-tour">
                                        ...
                                        <div class="client-review mb-80">
                                            ...
                                            <div class="client-review-list">
                                                <div class="client-review-item flex">
                                                    <div class="avata">
                                                        <img src="{{ asset('public/frontend') }}/images/avata/avt-review.jpg"
                                                            alt="image">
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="form-review bg-1">
                                            ...
                                            <form action="https://themesflat.co/" id="form-review">
                                                <div class="row">
                                                    <div class="col-md-6">
                                ...
                                <div class="col-lg-8">
                                    <div class="gallery-content-tour">
                                        <div class="image-gallery1 image">
                                            <img src="{{ asset('public/frontend') }}/images/gallery/gallery.jpg" alt="image"
                                                class="item1">
                                        </div>

                                        <div class="image-gallery2 image">
                                            <img src="{{ asset('public/frontend') }}/images/gallery/gallery2.jpg" alt="image"
                                                class="item2">
                                        </div>

                                        <div class="image-gallery3 image">
                                            <img src="{{ asset('public/frontend') }}/images/gallery/gallery3.jpg" alt="image"
                                                class="item1">
                                        </div>

                                        <div class="image-gallery4 image">
                                            <img src="{{ asset('public/frontend') }}/images/gallery/gallery4.jpg" alt="image"
                                                class="item2">
                                        </div>

                                        <div class="image-gallery5 image">
                                            <img src="{{ asset('public/frontend') }}/images/gallery/gallery5.jpg" alt="image"
                                                class="item1">
                                        </div>

                                        <div class="image-gallery6 image">
                                            <img src="{{ asset('public/frontend') }}/images/gallery/gallery6.jpg" alt="image"
                                                class="item2">
                                        </div>
                                    </div>
