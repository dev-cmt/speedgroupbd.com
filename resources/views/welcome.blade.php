                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <!-- <a href="#" class="btn-w-wa fadeInDown wow">Who we are <i class="icon-Group-13"></i></a> -->
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="slider-content">
                        <div class="tf-container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">Explore the world</span>
                                    <h1 class="title-slide text-white mb-32 fadeInDown wow">M & M
                                        <span class="animationtext clip text-main">
                                            <span class="cd-words-wrapper">
                                    ...
                                    <p class="des text-white mb-45 fadeInDown wow">
                                        Consumer product manufacturer & exporter
                                    </p>
                                    <div class="btn-group">
                                        <a href="#" class="btn-main fadeInDown wow">
                                            <p class="btn-main-text">Let,s get started</p>
                    ...
                    <div class="slider-content">
                        <div class="tf-container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">Explore the world</span>
                                    <h1 class="title-slide text-white mb-32 fadeInDown wow">Fly
                                        <span class="animationtext clip text-main">
                                            <span class="cd-words-wrapper">
...
@section('content')
            ...
            <div class="row pt-35">
                <div class="col-lg-12 flex">
                    <div class="image-list flex-three">
                        <img src="{{ asset('public/frontend') }}/images/avata/6.jpg" alt="Image" class="item">
                        <img src="{{ asset('public/frontend') }}/images/avata/5.jpg" alt="Image" class="item">
                        <img src="{{ asset('public/frontend') }}/images/avata/4.jpg" alt="Image" class="item">
                        <img src="{{ asset('public/frontend') }}/images/avata/3.jpg" alt="Image" class="item">
                        <img src="{{ asset('public/frontend') }}/images/avata/1.jpg" alt="Image" class="item">
                        <img src="{{ asset('public/frontend') }}/images/avata/2.jpg" alt="Image" class="item">
                        <div class="icon text-white item flex-five">
                            <i class="icon-uniE914"></i>
                        </div>
                    </div>
                    <p class="client fadeInUp wow">100+ people booked Tommorow land Event in last 24 hours</p>
                </div>
            </div>
            <div class="row pt-115">
                <div class="col-lg-6">
                    <div class="travel-video relative">
                        <img src="{{ asset('public/frontend') }}/images/about-us/image-video.png" alt="Image" class="image-video">
                        ...
                        <img src="{{ asset('public/frontend') }}/images/about-us/vali.png" alt="Image" class="mask-video tf-anime-rorate">
                        <img src="{{ asset('public/frontend') }}/images/page/enjoy.png" alt="Image" class="mask-enjoy ">
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="inner-content-about">
                        ...
                        <p class="des-heading fadeInUp wow">Welcome to our Print 128 website! We are a professional and reliable printing company that offers a wide range of printing services to</p>
                        <div class="row mt-27 fadeInUp wow">
                            <div class="col-sm-6">
                                <div class="icon-box-style3">
                                    ...
                                    <p class="des">Welcome to our Print 128 wesit! company that offers a wide r</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="icon-box-style3">
                                    ...
                                    <p class="des">Welcome to our Print 128 wesit! company that offers a
                                        wide r</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex-three btn-wrap-about mb-30 fadeInUp wow">
                            ...
                            <div class="profile flex-three">
                                <div class="image">
                                    <img src="{{ asset('public/frontend') }}/images/avata/10.jpg" alt="">
                                </div>
                                <div class="content">
                                    <img src="{{ asset('public/frontend') }}/images/page/name.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="center m0-auto w-text-heading">
                        <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the world</span>
                        <h2 class="title-heading mb-40 fadeInUp wow">Amazing Featured Tour <span class="text-gray font-yes">Package</span> the world</h2>
                    </div>
    ...
    <section class="relative tf-widget-activities pd-main overflow-hidden">
        <img src="{{ asset('public/frontend') }}/images/page/mask-activiti.png" alt="image" class="mask-top">
        <img src="{{ asset('public/frontend') }}/images/page/mask-print-2.png" alt="image" class="mask-bottom">
        <div class="tf-container">
                            ...
                            <button class="nav-link" id="cd-tab" data-bs-toggle="tab"
                                ...
                                <span class="icon flex-five">
                                    <svg width="59" height="55" viewBox="0 0 59 55" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M34.7241 5.70648C36.0557 5.50162 37.3873 6.42349 37.5921 7.75509"
                                            stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M37.5921 7.75502C37.3872 6.42342 38.3091 5.09182 39.6407 4.88696"
                                            stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M21.3057 3.45306C22.6373 3.2482 23.9689 4.17007 24.1737 5.50167"
                                            stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M24.1737 5.5016C23.9689 4.17 24.8907 2.83841 26.2223 2.63354"
                                            stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M49.8838 41.0452V50.5712" stroke="currentColor"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M35.2362 34.0798V38.5868" stroke="currentColor"
                                            stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M20.3838 32.0311V34.1821C20.3838 35.5137 19.257 36.6405 17.9255 36.6405H8.60427C7.27267 36.6405 6.14594 35.5137 6.14594 34.1821V32.0311C6.14594 30.6995 7.27267 29.5728 8.60427 29.5728H17.9255C19.257 29.5728 20.3838 30.6995 20.3838 32.0311Z"
                                            stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M13.2137 29.5728V36.6405" stroke="currentColor"
                                            stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                        ...
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                            ...
                            <div class="tabs-activities-content flex">
                                <div class="activities-image">
                                    <img src="{{ asset('public/frontend') }}/images/page/1.jpg" alt="Image">
                                </div>
                                <div class="activities-content relative">
                                    <span class="sub-title text-white">Welcome to our Print</span>
                                    <h3 class="title-activitis text-white mb-60">Real adventure & enjoy your
                                        dream tours</h3>
                                    ...
                                    <img src="{{ asset('public/frontend') }}/images/page/mask-tap.png" alt="image"
                                        class="mask-tab">
                                </div>
                            </div>
                        </div>
    ...
    <section class="offer-package pd-main bg-1 relative">
        <img src="{{ asset('public/frontend') }}/images/page/feature.jpg" alt="image" class="feature-ofer">
        <div class="tf-container">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-listing">
                                        <a href="{{route('page.package-details')}}" class="tour-listing-image">
                                            ...
                                            <img src="{{ asset('public/frontend') }}/images/travel-list/15.jpg"
                                                alt="Image Listing">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-listing">
                                        <a href="{{route('page.package-details')}}" class="tour-listing-image">
                                            ...
                                            <img src="{{ asset('public/frontend') }}/images/travel-list/16.jpg"
                                                alt="Image Listing">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-listing">
                                        <a href="{{route('page.package-details')}}" class="tour-listing-image">
                                            ...
                                            <img src="{{ asset('public/frontend') }}/images/travel-list/17.jpg"
                                                alt="Image Listing">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-listing">
                                        <a href="{{route('page.package-details')}}" class="tour-listing-image">
                                            ...
                                            <img src="{{ asset('public/frontend') }}/images/travel-list/18.jpg"
                                                alt="Image Listing">
    ...
    <section class="widget-counter relative">
        <img src="{{ asset('public/frontend') }}/images/page/couter-top.png" alt="image" class="counter-top">
        <img src="{{ asset('public/frontend') }}/images/page/counter-bottom.png" alt="image" class="counter-bottom">
        <div class="tf-container">
            <div class="row mb-50">
                <div class="col-lg-9 flex-three cta-wrap">
                    ...
                    <div class="content">
                        <h2 class="title-call text-white mb-18 fadeInUp wow">Ready to adventure and enjoy
                            natural</h2>
                        <p class="des text-white fadeInUp wow">Lorem ipsum dolor sit amet, consectetur
                            notted adipisicin
                        </p>
                    </div>
                </div>
            ...
            <div class="grid-three-destination">
                <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.1s">
                    <a href="single-destination.html" class="destination-imgae">
                        ...
                        <img src="{{ asset('public/frontend') }}/images/destination/list.jpg" alt="">
                    </a>
                ...
                <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.2s">
                    <a href="single-destination.html" class="destination-imgae">
                        ...
                        <img src="{{ asset('public/frontend') }}/images/destination/list1.jpg" alt="">
                    </a>
                    <div class="destination-content">
                ...
                <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.3s">
                    <a href="single-destination.html" class="destination-imgae">
                        ...
                        <img src="{{ asset('public/frontend') }}/images/destination/list2.jpg" alt="">
                    </a>
                    <div class="destination-content">
                ...
                <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.4s">
                    <a href="single-destination.html" class="destination-imgae">
                        ...
                        <img src="{{ asset('public/frontend') }}/images/destination/list3.jpg" alt="">
                    </a>
                    <div class="destination-content">
                ...
                <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.5s">
                    <a href="single-destination.html" class="destination-imgae">
                        <span class="tour">3 tours</span>
                        <img src="{{ asset('public/frontend') }}/images/destination/list4.jpg" alt="">
                    </a>
                    <div class="destination-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 widget-brand-logo">
                    <div class="swiper brand-logo overflow-hidden">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('public/frontend') }}/images/page/brand-logo.png" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('public/frontend') }}/images/page/brand-logo.png" alt="">
                            </div>
                    ...
                    <div class="adventure-content">
                        <nav class="mb-40 adventure-scroll">
                            <div class="nav nav-justified nav-tabs-adventure" id="nav-tab" role="tablist">
                                <li class="nav-link flex-three active" id="nav-home-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-hiking" role="tab"
                                    aria-controls="nav-hiking" aria-selected="true">
                                    <i class="icon-Group1"></i>
                                    <span>Hiking & Tracking</span>
                                </li>
                                <li class="nav-link flex-three" id="nav-river-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-river" role="tab" aria-controls="nav-river"
                                    aria-selected="false">
                                ...
                                <li class="nav-link flex-three" id="nav-animals-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-animals" role="tab" aria-controls="nav-animals"
                                    aria-selected="false">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-hiking" role="tabpanel"
                                tabindex="0">
                                <div class="row">
            ...
            <div class="row">
                <div class="col-md-5 relative">
                    <div class="image-box-tesimonial box-testimonial1 wow fadeInLeft animated "
                        data-wow-delay="0.1s">
                        <img src="{{ asset('public/frontend') }}/images/page/testimonial1.jpg" alt="">
                    </div>
                    <div class="image-box-tesimonial box-testimonial2 wow fadeInUp animated "
                        data-wow-delay="0.3s">
                        <img src="{{ asset('public/frontend') }}/images/page/testimonial2.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-7">
                        ...
                        <div class="swiper testimonial-image">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide avata">
                                    <img src="{{ asset('public/frontend') }}/images/avata/9.jpg" alt="Image Testimonial">
                                </div>
                                <div class="swiper-slide avata">
                                    <img src="{{ asset('public/frontend') }}/images/avata/7.jpg" alt="Image Testimonial">
                                </div>
                                <div class="swiper-slide avata">
                                    <img src="{{ asset('public/frontend') }}/images/avata/8.jpg" alt="Image Testimonial">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="tf-container">
            <div class="row z-index3 relative">
                <div class="col-lg-7 content-banner-contact">
                    ...
                    <img src="{{ asset('public/frontend') }}/images/page/vector2.png" alt="image" class="mask-icon-banner">
                </div>
                <div class="col-lg-5">
                    <div class="image-banner-contact">
                        <img src="{{ asset('public/frontend') }}/images/page/ewewe1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pd-main">
        <div class="tf-container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="center m0-auto w-text-heading">
                        <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">Explore the
                            world</span>
                        <h2 class="title-heading mb-40 wow fadeInUp animated">Latest news & articles <span
                                class="text-gray font-yes">from</span> the blog</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.1s">
                    <div class="tf-widget-blog blog-style">
                        <a href="blog-details.html" class="blog-image">
                            <img src="{{ asset('public/frontend') }}/images/blog/bl1.jpg" alt="">
                ...
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.2s">
                    <div class="tf-widget-blog blog-style">
                        <a href="blog-details.html" class="blog-image">
                            <img src="{{ asset('public/frontend') }}/images/blog/bl2.jpg" alt="">
                            <div class="category-blog">
                                <i class="icon-Group-8"></i>
                                <span>Business</span>
                            </div>
                ...
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.3s">
                    <div class="tf-widget-blog blog-style">
                        <a href="blog-details.html" class="blog-image">
                            <img src="{{ asset('public/frontend') }}/images/blog/bl3.jpg" alt="">
                            <div class="category-blog">
                                <i class="icon-Group-8"></i>
                                <span>Cavesse</span>
                            </div>
